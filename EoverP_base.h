...
#ifndef EoverP_base_h
#define EoverP_base_h
...
#ifdef EoverP_base_cxx
EoverP_base::EoverP_base(TTree *tree) : fChain(0) 
{
...
EoverP_base::~EoverP_base()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t EoverP_base::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t EoverP_base::LoadTree(Long64_t entry)
{
...
void EoverP_base::Init(TTree *tree)
{
...
void EoverP_base::Show(Long64_t entry)
{
...
Int_t EoverP_base::Cut(Long64_t entry)
{
...
void EoverP_base::Loop()
{
//   In a ROOT session, you can do:
//      root> .L EoverP_base.C
//      root> EoverP_base t
